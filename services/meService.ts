...
export type Profile = { userId: string; name: string; email: string; phone: string; cpf: string; address: string; city: string; complete: boolean };
...
export const meService = {
  ...
  updateProfile: (profile: Pick<Profile, 'name' | 'cpf' | 'phone' | 'address' | 'city'>) => publicApiPatch<Profile>('/api/me/profile', profile),
