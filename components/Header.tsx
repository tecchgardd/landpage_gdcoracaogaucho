...
import { faArrowLeft, faBars, faCartShopping, faChevronDown, faClipboardList, faIdCard, faMinus, faPlus, faTicket, faTrash, faXmark } from '@fortawesome/free-solid-svg-icons';
